...
<head>
  ...
  <title>THE GO BUS - Register Customers</title>
    ...
    <div style="display:none;" id="loadDiv" class="animate-bottom"> 
        <header>
          ...
          <ul>
            ...
            <li><a class="active" href="Datadisplay.php">Register Customers</a></li>
        ...
        <h1 style="margin-top: 0px;margin-left: 35% ; font-size: 55px; color: black">
              Register <span>Customers</span></h1>
	<table id="customers">
		<tr>
			<th>Id</th>
			<th>First_Name</th>
...
<?php
	...
	$sql = "SELECT id, First_Name, Last_Name, Email, Number, Account_Number, Pin_code, CNIC, Date, Departure, Arrival, Gender  FROM booking";
